...
$$\hat{y} = 73.18758 - 0.00067x_i$$
where the $$\hat{y}$$ is the estimated sustainability development index and $$x_i$$ is the country's GDP per capita in 2017 dollars.

The linear regression model coefficients are as follows:

The intercept of 73.18758 indicates when a country's GDP per capita is 0 dollars, the country's sustainability index in 73.18758.

The slope is -0.00067. We estimate that for every 10000 increase in a county's GDP per capita, their sustainability development index will decrease by 6.7.
